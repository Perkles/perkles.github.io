...
Antes de você gastar milhares de dólares e vários meses da sua vida em um bootcamp de programação, gaste 30 minutos lendo esse manual.
...
Como professor fundador do freeCodeCamp, estou em uma posição única para escrever sobre bootcamps por três razões:
 ...
 - 3 Nos últimos 3 anos conduzi pesquisas significantes. Publiquei muitos [conjuntos de dados]() contendo respostas de milhares de ex alunos.
...
"O melhor bootcamp pega pessoas com habilidades brutas e os transformam (sutilmente) em programadores experientes. O que eles fazem na maioria dos casos é selecionar e colocam pessoas em panelas de pressão de aprendizado" - Um ex organizador de bootcamp que conversei.
